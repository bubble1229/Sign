...
//            canvas.drawBitmap(((BitmapDrawable)getResources().getDrawable(R.drawable.corner_view_bg_checkin,null)).getBitmap());
//            canvas.drawBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.corner_view_bg_checkin),10,10,mPaint);
//            canvas.drawCircle(40, 40, 30, mPaint);
//            mPaint.setTextScaleX(20);
