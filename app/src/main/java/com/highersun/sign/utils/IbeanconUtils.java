    ...
    public static IbeaconBean fromScanData(BluetoothDevice device, int rssi, byte[] scanData){
        ...
        while (startByte <= 5) {
            if (((int)scanData[startByte+2] & 0xff) == 0x02 &&
                ...
                IbeaconBean iBeacon = new IbeaconBean();
                iBeacon.name = Math.pow(10,Math.abs(iBeacon.txPower)-59/(10*2.0))+"米";
                iBeacon.major = 0;
                iBeacon.minor = 0;
                iBeacon.proximityUuid = "00000000-0000-0000-0000-000000000000";
                iBeacon.txPower = -55;
        ...
        iBeacon.rssi = rssi;
        iBeacon.setDistance(String.format("%.2f",Math.pow(10,(Math.abs(iBeacon.rssi)-59)/(10*2.0)))+"米");
