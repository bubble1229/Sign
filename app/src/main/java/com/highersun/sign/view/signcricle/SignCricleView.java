package com.highersun.sign.view.signcricle;
...
//        mGradientRingPaint.setStrokeCap(Paint.Cap.ROUND);
    ...
    public void startAnim(int minute) {


        ValueAnimator mAngleAnim = ValueAnimator.ofFloat(mCurrentAngle, minute*mTimeAngle);
