...
//		@Override
//		public void onItemChange(int year, int month, int day) {
//		}
//	};
			...
			public void onItemSelected(int index) {
				...
				if(year_num == endYear){
					...
					if(wv_month.getCurrentItem() + 1 > endMonth){
						...
						wv_day.setAdapter(new NumericWheelAdapter(1, endDay));
						wv_day.setCurrentItem(endDay - 1);
					}
				}else{
					wv_month.setAdapter(new NumericWheelAdapter(1, 12));
...
//					onItemChangeListener.onItemChange(wv_year.getCurrentItem() + startYear, wv_month.getCurrentItem() + 1, wv_day.getCurrentItem() + 1);
				}
		...
		OnItemSelectedListener wheelListener_month = new OnItemSelectedListener() {
			...
			public void onItemSelected(int index) {
				...
				if(year_num == endYear && month_num == endMonth){
					wv_day.setAdapter(new NumericWheelAdapter(1, endDay));
...
//		void onItemChange(int year, int month, int day);
//	}
